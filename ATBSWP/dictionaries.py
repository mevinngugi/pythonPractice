...
inventory will be a dictionary where the keys are string values describing
the item in the inventory and the value is an integer value detailing
...
is a dictionary representing the player’s inventory (like in the previous project) and
...
dragonLoot = ['gold coin', 'dagger', 'gold coin', 'gold coin', 'ruby', 'I did it', 'I did it']
#inv = {'gold coin': 42, 'rope': 1}
